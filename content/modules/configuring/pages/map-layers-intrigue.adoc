...
= Configuring Map Layers for {catalog-ui}
...
Equivalent addition and deletion of a map layer can be found in xref:map-configuration-intrigue.adoc[Map Configuration for {catalog-ui}].
